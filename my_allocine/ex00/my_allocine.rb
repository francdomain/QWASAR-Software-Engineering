...
requests["Find the actors with all information who played a role in the movies 'Annie Hall'"] = "SELECT actors.id, actors.act_fname, actors.act_lname, actors.act_gender
FROM actors 
